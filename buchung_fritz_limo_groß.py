...
VALUES  ("Fritz-limo / Fritz-kola gross", "1.55€", "1", DATETIME('now'), ?);""", (_uid,))

    connection.commit()
except (connection.Error, connection.Warning) as e:
    print(e)
finally:
    print ("1 große Fritz-limo / Fritz-kola wurde erfolgreich gebucht")
    print ("------------------------------------------------------")
...
sql_command = """ UPDATE lager SET bestand = bestand - 1 WHERE getraenke_name = "Fritz-limo / Fritz-kola gross" """
