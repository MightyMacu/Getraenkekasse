...
VALUES  ("Ratsherrn Pilsener", "0.85€", "1", DATETIME('now'), ?);""", (_uid,))
    ...
    print ("1 kleines Ratsherrn Pilsener wurde erfolgreich gebucht")
    print ("------------------------------------------------------")
...
sql_command = """ UPDATE lager SET bestand = bestand - 1 WHERE getraenke_name = "Ratsherrn Pilsener" """
