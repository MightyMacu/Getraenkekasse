...
VALUES  ("Astra klein Kiezmische / Rakete / Rotlicht / Urtyp", "0.80€", "1", DATETIME('now'),  ?);""", (_uid,))

    connection.commit()
except (connection.Error, connection.Warning) as e:
    print(e)
finally:
    print ("1 kleines Astra Kiezmische / Rakete / Rotlicht / Urtyp wurde erfolgreich gebucht")
    print ("--------------------------------------------------------------------------")
...
sql_command = """ UPDATE lager SET bestand = bestand - 1 WHERE getraenke_name = "Astra klein Kiezmische / Rakete / Rotlicht / Urtyp" """
