...
VALUES  ("28 Black", "1.75€", "1", DATETIME('now'),  ?);""", (_uid,))

    connection.commit()
except (connection.Error, connection.Warning) as e:
    print(e)
finally:
    print ("1 28 Black (0.25l) wurde erfolgreich gebucht")
    print ("------------------------------------------------------")
...
sql_command = """ UPDATE lager SET bestand = bestand - 1 WHERE getraenke_name = "28 Black" """
