...
VALUES  ("Fritz-limo / Fritz-kola klein", "1.10€", "1", DATETIME('now'), ?);""", (_uid,))

    connection.commit()
except (connection.Error, connection.Warning) as e:
    print(e)
finally:
    print ("1 kleine Fritz-limo wurde erfolgreich gebucht")
    print ("------------------------------------------------------")
...
sql_command = """ UPDATE lager SET bestand = bestand - 1 WHERE getraenke_name = "Fritz-limo / Fritz-kola klein" """
