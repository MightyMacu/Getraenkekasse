...
VALUES  ("Bionade 0.33l", "0.90€", "1", DATETIME('now'),  ?);""", (_uid,))

    connection.commit()
except (connection.Error, connection.Warning) as e:
    print(e)
finally:
    print ("1 Bionade (0.33l) wurde erfolgreich gebucht")
    print ("------------------------------------------------------")
...
sql_command = """ UPDATE lager SET bestand = bestand - 1 WHERE getraenke_name = "Bionade 0.33l" """
